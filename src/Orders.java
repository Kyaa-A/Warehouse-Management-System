                ...
                if (selectedRow != -1) {
                    ...
                    """;
                        ...
                        if (rs.next()) {
                            ...
                            jLabel13.setText("<html><div style='width:100px;'>" + rs.getString("address") + "</div></html>");
                            jLabel14.setText(rs.getString("products"));
                            jLabel15.setText(new DecimalFormat("₱#,##0.00").format(rs.getDouble("total")));
